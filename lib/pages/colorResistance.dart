...
import 'package:calculador_resistencia/calculations/painter.dart';
...
class Resistors {
  ...
  static List<Resistors> getResistors() {
    return <Resistors>[
      Resistors(3,'3 Bandas'),
      Resistors(4,'4 Bandas'),
      Resistors(5,'5 Bandas'),
    ];
  }
...
class _ResistanceFindState extends State<ResistanceFind> {
  ...
  String getAnswer(int id, List<Color> colors) {
    ...
    return "${formatNum(resistance)}\nTolerancia: ${tolerance == null ? "|" : "$tolerance%"}";
  }
