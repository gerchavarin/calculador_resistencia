...
class RTypes {
  ...
  static List<RTypes> getRTypes() {
    return <RTypes>[
      RTypes('E3 - Tolerancia: 40%', 40.0,'Sets/E3.txt',4.7),
      RTypes('E6 - Tolerancia: 20%', 20.0,'Sets/E6.txt',6.8),
      RTypes('E12 - Tolerancia: 10%', 10.0,'Sets/E12.txt',8.2),
      RTypes('E24 - Tolerancia: 5%', 5.0,'Sets/E24.txt',9.1),
      RTypes('E48 - Tolerancia: 2%', 2.0,'Sets/E48.txt',9.53),
      RTypes('E96 - Tolerancia: 1%', 1.0,'Sets/E96.txt',9.76),
      RTypes('E192 - Tolerancia: 0.5%', 0.5,'Sets/E192.txt',9.88),
    ];
  }
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Ingrese un valor de resistencia diferente.'),
          actions: <Widget>[
            FlatButton(
              child: Text('OK'),
              onPressed: () {
            ...
            Hero(
              ...
              child: ButtonTheme(
                ...
                child: RaisedButton.icon(
                  ...
                  icon: Icon(Icons.calculate,size: 35.0,color: Colors.white,),
                  label: Text(
